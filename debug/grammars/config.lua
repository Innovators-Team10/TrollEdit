cfg_keys = {"text_style", "comment_style", "keyword", "line_comment", "multi_comment", "string_constant", "character_constant", "number_constant", "label", "assignment_operator", "binary_operator", "prefix_operator", "postfix_operator", "markup_tag", "attribute_key", "attribute_value", "block_style", "if_statement", "unknown", "preprocessor", "while_statement", "for_statement", "switch_statement", "funct_param", "block", "funct_definition", "funct_call"}
...
block_style = {target="block", hovered="", selected="blue", showing="orange"}
